        ...
        <section className="py-12 bg-white sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Les services que nous offrons</h2>
                ...
                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div className="md:p-8 lg:p-14">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Freelancers</h3>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Travails</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Publicités</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>
