                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl font-bold sm:text-6xl">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white">
                                Trouvez le freelance idéal ou l&apos;opportunité parfaite en un clic!
                            </span>
                        </h1>
                            
                        <p className="mt-5 text-base text-white sm:text-xl">
                            Une plateforme rapide et gratuite pour trouver des freelances qualifiés ou des opportunités de travail.
                            Créez, postulez ou embauchez, tout simplement.
                        </p>

                        <Link href="/" title="" className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-primary rounded-lg sm:mt-12 hover:bg-primary/90 focus:bg-white" role="button">
                            Postulez gratuitement
